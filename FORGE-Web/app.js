...
function setPlan(plan) {
  ...
  saveUser();
  const msgs = { free:'Plan Gratuit activé.', pro:'Plan Pro activé ! Fonctionnalités débloquées.', elite:'Plan Elite activé ! Bienvenue dans l\'élite.' };
  notify(plan==='free'?'🔓':plan==='pro'?'⚡':'👑', msgs[plan]);
  renderSubscription();
}
